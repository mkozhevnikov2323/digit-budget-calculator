# Digit Budget Calculator

Digit Budget Calculator — это современное веб-приложение для учёта и анализа личных финансов. Проект реализован на React (с применением архитектурного паттерна FSD — Feature Sliced Design), что обеспечивает масштабируемость, модульность и высокое качество кода.
...
Digit Budget Calculator — ваш эффективный помощник по управлению финансами.
